...
static const int aEqmidToBitrateSortedID[]={ 0, 1, 4, 2, 3};
static const int sizeOfEqmidToBitrateSortedIdTable = (int)(sizeof(aEqmidToBitrateSortedID)
...
int ldac_ABR_Init( HANDLE_LDAC_ABR hLdacAbr, unsigned int interval_ms )
{
    ...
    hLdacAbr->nPenalty = 1;
    hLdacAbr->EqmidSteady = aEqmidToBitrateSortedID[LDACBT_EQMID_HQ];
