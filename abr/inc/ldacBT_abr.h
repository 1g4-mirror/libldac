 ...
 *   state of the TX queue changes greatly, such as clears the queue.
 ...
 *       The ABR handle adjusts eqmid based on TxQueueDepth which is passed from program.
 ...
 *      int: 0 for success, -1 for failure.
 *  Remarks
 *    Those thresholds should be the number of packets stored in the TX queue.
 *    The thCritical and thDangerousTrend are used for all eqmid and thSafety4HQSQ is used
 *    only for LDACBT_EQMID_HQ and LDACBT_EQMID_SQ.
 */
