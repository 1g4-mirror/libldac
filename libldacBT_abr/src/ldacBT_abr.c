...
#define ABRDBG(fmt, ...) \
    _android_log_print(ANDROID_LOG_INFO, "***LDAC ABR***", \
...
/******************************************************************************
**
** Function ldac_ABR_get_handle
**
** Description Get LDAC ABR handle.
** interval_ms : set the interval between LDAC encodeing in ms
**
** Returns Pointer to HANDLE_LDAC_ABR.
******************************************************************************/
...
/******************************************************************************
**
** Function ldac_ABR_free_handle
**
** Description Free LDAC ABR handle.
**
** Returns void.
******************************************************************************/
...
/******************************************************************************
**
** Function ldac_ABR_Init
**
** Description Initialize LDAC ABR.
** interval_ms : set the interval between LDAC encodeing in ms
**
** Returns if 0 success, other fail.
******************************************************************************/
int ldac_ABR_Init(HANDLE_LDAC_ABR hLdacAbr, int interval_ms)
{
    ...
    if (interval_ms <= 0)
	    interval_ms = 20; /* 20 : default interval */
    ...
    hLdacAbr->TxQD_Info.pHist =
            (SINT8*)malloc(hLdacAbr->TxQD_Info.szHist * sizeof(SINT8));
...
/******************************************************************************
**
** Function ldac_ABR_set_threasholds
**
** Description Setup threasholds for LDAC ABR.
**
** Returns if 0 success, other fail.
******************************************************************************/
int ldac_ABR_set_threasholds(HANDLE_LDAC_ABR hLdacAbr, int thCritical,
...
/******************************************************************************
**
** Function ldac_ABR_Proc
**
** Description LDAC ABR main process.
**
** Returns int : updated Encode Quality Mode Index.
******************************************************************************/
                  ...
                  int TxQueueDepth, int flgEnable)
{
    ...
    hLdacAbr->TxQD_Info.pHist[hLdacAbr->TxQD_Info.idx] = (SINT8)TxQD_curr;
